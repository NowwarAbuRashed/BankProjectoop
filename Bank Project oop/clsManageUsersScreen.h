...
private:
    ...
    static void _PerfromManageUsersOption(enManageUsersOptions ManageUsersOptions)
    {
...
public:
    ...
    static void ShowManageUsersMenue()
    {
        ...
        cout << setw(37) << left << "" << "===========================================\n";
        _PerfromManageUsersOption((enManageUsersOptions) ReadManageUsersMenueOption());
